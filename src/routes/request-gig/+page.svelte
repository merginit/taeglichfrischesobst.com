<script lang="ts">
	...
	const submitGigLocationSuggestion = async function (event: Event) {
		...
		for (const [key, value] of data.entries()) {
			if (key === 'city' && city_not_in_list) {
				values.push(data.get('alt_city'));
			} else if (key === 'alt_city') {
				continue;
			} else {
				values.push(value);
			}
		...
		<form on:submit|preventDefault={submitGigLocationSuggestion} class="flex flex-col gap-2">
			...
			{#if country === 'Österreich'}
				<select name="city" class="w-full select" bind:value={city}>
					...
					<option value="Krems an der Donau,Niederösterreich"
						>Krems an der Donau, Niederösterreich</option
					>
					...
					<option value="Saalfelden am Steinernen Meer,Salzburg"
						>Saalfelden am Steinernen Meer, Salzburg</option
					>
					<option value="Stockerau,Niederösterreich">Stockerau, Niederösterreich</option>
					<option value="Tulln an der Donau,Niederösterreich"
						>Tulln an der Donau, Niederösterreich</option
					>
					...
					<option value="Gerasdorf bei Wien,Niederösterreich"
						>Gerasdorf bei Wien, Niederösterreich</option
					>
					...
					<option value="Waidhofen an der Ybbs,Niederösterreich"
						>Waidhofen an der Ybbs, Niederösterreich</option
					>
					<option value="Trofaiach,Steiermark">Trofaiach, Steiermark</option>
					<option value="Völkermarkt,Kärnten">Völkermarkt, Kärnten</option>
					<option value="Zwettl-Niederösterreich,Niederösterreich"
						>Zwettl-Niederösterreich, Niederösterreich</option
					>
			...
			{:else if country === 'Schweiz'}
				<select name="city" class="w-full select" bind:value={city}>
					...
					>
					<option value="La Chaux-de-Fonds,Kanton Neuenburg"
						>La Chaux-de-Fonds, Kanton Neuenburg</option
					>
					...
					<option value="Rapperswil-Jona,Kanton St. Gallen"
						>Rapperswil-Jona, Kanton St. Gallen</option
					>
					...
					<option value="Allschwil,Kanton Basel-Landschaft"
						>Allschwil, Kanton Basel-Landschaft</option
					>
					...
					<option value="Herisau,Kanton Appenzell Ausserrhoden"
						>Herisau, Kanton Appenzell Ausserrhoden</option
					>
