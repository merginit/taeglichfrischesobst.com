...
cc.run({
    ...
    onAccept: function (cookie) {
        // callback triggered when user accepts cookies
    },
    ...
    languages: {
        'de': {
            consent_modal: {
                ...
                description: 'Hallo, diese Website verwendet notwendige Cookies, um ihren ordnungsgemäßen Betrieb sicherzustellen, und Tracking-Cookies, um zu verstehen, wie Sie mit ihr interagieren. Letztere werden nur nach Zustimmung gesetzt. <button type="button" data-cc="c-settings" class="cc-link">Lass mich wählen</button>',
                primary_btn: {
                ...
                blocks: [
                    {
                        ...
                        description: 'Zur Integration von Einbettungen von Drittanbietern verwendet die Website Cookies. Diese Cookies sind notwendig, um die Einbettungen zu laden.',
                        toggle: {
                            value: 'embedding',     // Ihre Cookie-Kategorie
                            enabled: false,
                            readonly: false
                        },
                        cookie_table: [             // Liste aller erwarteten Cookies
                            {
                                col1: 'sp*',
                        ...
                        description: 'Bei Fragen zu unserer Cookie-Richtlinie und Ihren Auswahlmöglichkeiten kontaktieren Sie uns bitte unter <a class="cc-link" href="/home#contact">Kontakt</a>.',
                    }
                ]
            }
        }
