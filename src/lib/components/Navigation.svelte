...
<nav class="sticky top-0 z-40" bind:offsetHeight={nh}>
	...
	<div class="overflow-hidden">
		<div class="absolute top-0 w-full h-2 bg-neutral" />
		<!-- prettier-ignore -->
		<svg class="absolute top-0 pt-2 pointer-events-none" version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1440 320" style="enable-background:new 0 0 1440 320;" xml:space="preserve"><path class="fill-neutral" d="M0,162.6l30-11.6c30-11.6,90-34.8,150-27.1c60,7.5,120,46.7,180,46.4c60,0.2,120-39,180-69.7c60-31,120-54.2,180-38.8c60,15.7,120,69.4,180,85.2c60,15.5,120-7.8,180-7.8s120,23.2,180,38.7c60,15.7,120,23,150,27.1l30,3.8V0h-30c-30,0-90,0-150,0s-120,0-180,0S960,0,900,0S780,0,720,0S600,0,540,0S420,0,360,0S240,0,180,0S60,0,30,0H0V162.6z"/></svg>
	</div>
</nav>
